...
<header class="bg-white shadow bg-black bg-opacity-80">
    <nav class="mx-auto flex max-w-7xl items-center justify-between py-3" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="/" class="-m-1.5 p-1.5 flex">
          <img class="h-8 w-auto" src="https://www.sveltycms.com/SveltyCMS_Logo.svg" alt="">
          <span class="">SveltyCMS</span>
        </a>
      </div>
